...
var gs_bootgitstrap_url="js/bootgitstrap.min.js";var gs_default_theme_url="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css";var gs_css_url="css/gitstrap.css"
...
</div> <!-- /container -->';window.onload=function(){if(document.head==null){alert("You must update your browser to view this website.");}
document.head.innerHTML=gs_html_head_tag;document.body.innerHTML=gs_html_body_tag;setTitle(gsConfig.title);setTheme(gsConfig.theme);add_style(gs_css_url);var scripts=[gs_jquery_url,gs_bootstrap_url,gs_showdown_url,gs_jsyaml_url,gs_bootgitstrap_url];loadAndExecuteScripts(scripts,0,function(){});}
