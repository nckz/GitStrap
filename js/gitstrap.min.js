...
function PostToHTML(relpath,markdown_body){var callback=function(text){var body=document.getElementById(markdown_body);var post_head=document.createElement('div');var post_body=document.createElement('div');body.appendChild(post_head);body.appendChild(post_body);if(text==null){post_head.innerHTML='Unable to load text for: '+relpath;return;}
