...
<!-- GitStrip.js --> \
<script src="js/gitstrap.js"></script> ';function loadAndExecuteScripts(aryScriptUrls,index,callback){$.getScript(aryScriptUrls[index],function(){if(index+1<=aryScriptUrls.length-1){loadAndExecuteScripts(aryScriptUrls,index+1,callback);}else{if(callback)
callback();}});}
function add_style(url){new_style='<link rel="stylesheet" href="'+url+'" type="text/css" media="screen" />';$('head').append(new_style);}
window.onload=function(){document.head.innerHTML=gs_html_head_tag;document.body.innerHTML=gs_html_body_tag;add_style("http://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css");add_style("css/gitstrap.css");var bootstrap="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js";var showdown="https://cdn.rawgit.com/showdownjs/showdown/1.3.0/dist/showdown.min.js";var jsyaml="https://cdn.rawgit.com/nckz/GitStrap/fa12906d40aac6596f8d7601fddf7b21dc9b47a3/js/js-yaml-front-client.min.js"
...
var gitstrap="js/gitstrap.js";var scripts=[bootstrap,showdown,jsyaml,gitstrap];loadAndExecuteScripts(scripts,0,function(){});}